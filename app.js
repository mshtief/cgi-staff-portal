  ...
  if (id === "job-description") {
    ...
    body =
      ...
      sec("🏠 Where you'll stay", boys
        ? `<p>Room and board at the <strong>Rabbinical College / Yeshiva</strong>. Bring your own linens.</p>`
      ...
      sec("🍽️ Food", boys
        ? `<p>All your meals are at the <strong>Yeshiva dining room</strong>, with <strong>lunch at camp.</strong> Once a week we do a <strong>BBQ</strong> — at a director's home, a camp family, or at camp — and another night you'll <strong>go out to a restaurant on us</strong> (about <strong>$10–$20</strong> per person). Breakfast's in the dining room each morning.</p>`
